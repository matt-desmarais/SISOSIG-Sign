...
A Raspberry Pi + Pimoroni Inky e‑paper display project that shows live SISOSIG / MassDOT traffic imagery in a clean, appliance‑style way.

This project is designed to be **robust**, **hands‑off**, and **museum / counter / wall‑display safe**:
...
## ▶️ Running Manually (for testing)
